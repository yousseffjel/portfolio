  ...
  return (
    <section
      ...
      className={`relative min-h-screen flex flex-col justify-center items-center px-4 text-center transition-all duration-300 ${
        darkMode ? 'bg-gradient-to-b from-gray-900 to-gray-800 text-white' : 'bg-gradient-to-b from-gray-100 to-gray-50 text-gray-900'
      }`}
    >
      <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-4 animate-fade-in">
        Hi, I’m <span className="text-blue-500">Youssef Fjel</span>
      </h1>

      <p className="text-lg sm:text-xl md:text-2xl mb-6 max-w-2xl">
        I’m a <span className="text-blue-500">{currentRole}</span>
        <span className="blinking-cursor">|</span> {/* Blinking cursor effect */}
      </p>
      ...
      <div className="mt-8 flex space-x-6">
        <a href="https://github.com/your-profile" className="text-gray-400 hover:text-white text-2xl transition duration-300">
          <i className="fab fa-github"></i>
        </a>
        <a href="https://linkedin.com/in/your-profile" className="text-gray-400 hover:text-white text-2xl transition duration-300">
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="mailto:you@example.com" className="text-gray-400 hover:text-white text-2xl transition duration-300">
